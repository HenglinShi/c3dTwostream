...
def main():
    ...
    weightPath = 'fctw0c3d_ucf101_finetune_whole_iter_47685.caffemodel'
    ...
    batchNumPerEpoch_train = np.ceil(sampleNum_train * 1.0/videoNumPerBatch_train).astype('int')
    batchNumPerEpoch_test = np.ceil(sampleNum_test *1.0/videoNumPerBatch_test).astype('int')
